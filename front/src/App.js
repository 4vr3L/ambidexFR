  ...
  return (
    <div className="bg-black flex flex-col items-center w-full">
      ...
      <header className="fixed z-50 w-full max-w-[1252px] top-[50px] px-4">
        <Card className="relative w-full h-[62px] bg-[#000000cc] rounded-[1000px] backdrop-blur-[7.5px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(7.5px)_brightness(100%)] border-none">
